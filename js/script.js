...
const handleDarkMode = () => {
  //circle_btn.classList.toggle("switch");
  if (circle_btn.classList.contains("switch")) {
    ...
    green_icon.src = "./assets/cib_greensock.svg";
    github_icon.src = "./assets/akar-icons_github-fill.svg";
    ...
    green_icon.src = "./assets/dark-mod-green.svg";
    github_icon.src = "./assets/dark-mod-github.svg";
...
//Handle Dark Mod
dark_mod_btn_container.addEventListener("click", handleDarkMode);
